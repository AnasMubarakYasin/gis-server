...
module.exports = class Authorization {
  ...
  async init() {
    ...
    if (this.opts.interchange) {
      this.interchange = this.opts.interchange;
    } else {
